...
import {  Clapperboard, Dumbbell, MapPin, ShoppingBasket, Utensils, Wifi, Wine, WineIcon } from "lucide-react";
...
const HotelDetailsClient = ({hotel, bookings}: {hotel: HotelWithRooms, bookings?:Booking[]}) => {
    ...
    return ( <div className="flex flex-col gap-6 pb-2">
         <div className="aspect-square overflow-hidden relative w-fullh-[200px] md:h-[400px] rounded-lg ">
           <Image 
             fill
             src={hotel.image}
             alt={hotel.title}
            ...
            <div className="">
             ...
             <div className="grid grid-cols-2 md:grid-cols-3 gap-4 content-start text-sm">
                {hotel.swimmingPool && <AmenityItem><FaSwimmer size={18}/>Pool</AmenityItem>}
                 ...
                 {hotel.restaurant && <AmenityItem><Utensils className="w-4 h-4"/> gym </AmenityItem>}
                 ...
                 {hotel.coffeeShop && <AmenityItem><WineIcon className="w-4 h-4"/> Coffee Shop </AmenityItem>}
